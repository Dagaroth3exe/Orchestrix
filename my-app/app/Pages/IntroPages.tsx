...
const INTRO_FADE_DELAY = 4.2;
const INTRO_REDIRECT_MS = 4800;
...
const IntroPage = () => {
    ...
    return (
        <motion.div
            className="min-h-screen w-full flex items-center justify-center flex-col gap-10 px-6 text-center"
            initial={{ opacity: 1 }}
            animate={{ opacity: 0 }}
            transition={{ duration: 0.6, ease: "easeInOut", delay: INTRO_FADE_DELAY }}
        >
            <motion.div
